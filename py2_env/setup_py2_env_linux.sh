...
conda env create -f /home/anagabandi/py2_env/py2_env.yml
conda env update

echo "Conda environment created! Make sure to run \`source activate py2_env\` whenever you open a new terminal and want to run programs under py2_env."
