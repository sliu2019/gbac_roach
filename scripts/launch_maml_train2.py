...
def run(d):
	...
	# old_model_num = 0
	previous_dynamics_model = "/home/anagabandi/rllab-private/data/local/experiment/MAML_roach_copy/Tuesday_optimization/turf/model_epoch10"
...
def main(config_path, extra_config):
	...
	vg.add('update_lr', [0.001]) #[1.0, 0.1, 0.01, 0.001]
	...
	for v in vg.variants():
		...
		v['exp_name'] = "MAML_roach_copy/Tuesday_optimization/turf"
		run_experiment_lite(
			run,
			sync_s3_pkl=True,
			periodic_sync=True,
